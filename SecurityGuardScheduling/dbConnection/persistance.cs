...
namespace dbConnection
{
    class persistanceClass
    {
        ...
        {
            //IF Statment to instantiate connection String.
                //if Database is Oracle
            if (dataBaseType == supportedDbList.Oracle_10g.ToString()) 
            {
            ...
            else if (dataBaseType == supportedDbList.MsSqlServer.ToString())
            {

            }
            //if Database is MySql
            else if (dataBaseType == supportedDbList.MySQL_5x.ToString())
            {
                this.connectionString = "DRIVER={MySQL ODBC 3.51 Driver}; " +
                        "SERVER = " + hostName + "; PORT=" + portAddress + 
            ...
            //if Database is Microsoft Access 2007
            else if (dataBaseType == supportedDbList.MsAccess_2007.ToString())
            {
                this.connectionString = "Driver={Microsoft Access Driver (*.mdb, *.accdb)};Dbq=" +
                        dataBaseName + "; UID= " + userName + ";PWD= " + passWord + ";";
                this.odbcDataConnection = new OdbcConnection();
                this.odbcDataConnection.ConnectionString = this.connectionString;
                this.DBaseType = "MsAccess";
            }
        }
        ...
        private void recordError(string errorMesg)
        {
