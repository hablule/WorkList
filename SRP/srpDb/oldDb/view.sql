CREATE VIEW "C_ADEMPIERE"."T" 
("C_INVOICE_ID","AD_CLIENT_ID","AD_ORG_ID","ISACTIVE","CREATED","CREATEDBY","UPDATED","UPDATEDBY",
"ISSOTRX","DOCUMENTNO","DOCSTATUS","DOCACTION","PROCESSING","PROCESSED","C_DOCTYPE_ID",
"C_DOCTYPETARGET_ID","C_ORDER_ID","DESCRIPTION","ISAPPROVED","ISTRANSFERRED","SALESREP_ID",
"DATEINVOICED","DATEPRINTED","DATEACCT","C_BPARTNER_ID","C_BPARTNER_LOCATION_ID","AD_USER_ID",
"POREFERENCE","DATEORDERED","C_CURRENCY_ID","C_CONVERSIONTYPE_ID","PAYMENTRULE","C_PAYMENTTERM_ID",
"C_CHARGE_ID","M_PRICELIST_ID","C_CAMPAIGN_ID","C_PROJECT_ID","C_ACTIVITY_ID","ISPRINTED","ISDISCOUNTPRINTED",
"ISPAID","ISINDISPUTE","ISPAYSCHEDULEVALID","C_INVOICEPAYSCHEDULE_ID","INVOICECOLLECTIONTYPE","DUNNINGGRACE",
"CHARGEAMT","TOTALLINES","GRANDTOTAL","MULTIPLIER","MULTIPLIERAP","DOCBASETYPE","DUEDATE") 
