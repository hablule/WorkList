...
namespace SRP {
    ...
    public class crptPhysicalCount : ReportClass {
        
        public crptPhysicalCount() {
        }
        
        public override string ResourceName {
            get {
                return "crptPhysicalCount.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SRP.crptPhysicalCount.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedcrptPhysicalCount : Component, ICachedReport {
        
        public CachedcrptPhysicalCount() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            crptPhysicalCount rpt = new crptPhysicalCount();
            rpt.Site = this.Site;
            return rpt;
        }
