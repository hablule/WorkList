...
namespace EasyMove
{
    public partial class frmInventoryIn : Form
    {
        public frmInventoryIn()
        {
            InitializeComponent();
        }
        ...
        bool userCanCreateInventoryIn = false;
        ...
        taskType enmCurrentTask = taskType.In;
        ...
        private void enableDisableNewButton()
        {
            ...
            if (this.userCanCreateInventoryIn)
        ...
        {            
            ...
            this.ddgBpartner.SelectedItem =
                    this.dtgMoveSummary.SelectedRows[0].Cells["VENDOR"].Value.ToString();            
        }
        ...
        { 
            ...
            if (this.getDataFromDb.checkIfTableContainesData(this.dtRecordDetailData))
            {
                       ...
                       rowCounter >= 0; rowCounter--)
                {
                    ...
                    if (this.dtRecordDetailData.Rows[rowCounter]["C_INVOICELINE_ID"].ToString() != "")
                    {
                        invoiceDetail =
                            this.getDataFromDb.getINVOICEDETAILInfo(null, "", "", "", "",
                                this.dtRecordDetailData.Rows[rowCounter]["C_INVOICELINE_ID"].ToString(),
                                "", "", false, false, "AND", "", "");

                        if (this.getDataFromDb.checkIfTableContainesData(invoiceDetail))
                        {
                            this.dtRecordDetailData.Rows[rowCounter]["Invoice NO"] =
                                invoiceDetail.Rows[0]["DOCUMENTNO"].ToString();
                            this.dtRecordDetailData.Rows[rowCounter]["Invoiced"] =
                                invoiceDetail.Rows[0]["QTYENTERED"].ToString();
                            this.dtRecordDetailData.Rows[rowCounter]["Received"] =
                                invoiceDetail.Rows[0]["QTYRECEIVED"].ToString();
                        }
                    }
                }
            }
        ...
        {
            this.enmCurrentTask = taskType.In;            
        }
        ...
        private void changeInterfaceToCurrentTaskAndRecordMode()
        {
            ...
            this.lblMovementDate.Text = "Date Received";
            this.lblWareHouse.Text = "Received To";
        ...
        {
            userAccessPrevilageInformation.canCreateNewInventoryIn = 
                this.canUserCreateInventoryIncoming();
            ...
            {
                if (currentUserCurrentRecordProcessAcess.Rows[0]["CREATEINVENTORYIN"].ToString() == "N" &&
                    currentUserCurrentRecordProcessAcess.Rows[0]["CONFIRMINVENTORYIN"].ToString() == "N")
                {
                    return;
                }
            }
            ...
            if (currentUserCurrentRecordProcessAcess.Rows[0]["CREATEINVENTORYIN"].ToString() == "Y")
            {
                userAccessPrevilageInformation.canCreateNewInventoryIn = true;
            }
            else
                userAccessPrevilageInformation.canCreateNewInventoryIn = false;
        }

        private bool canUserCreateInventoryIncoming()
        {
            return this.canUserCreateInventoryIncoming(this.enmCurrentRecordType == recordType.Existing);
        }

        private bool canUserCreateInventoryIncoming(bool checkWareHouse)
        {
            if (userAccessPrevilageInformation.userStationprevilageIsReadOnly)
            {
                return false;
            ...
            drCriterionRow["Field"] = "CREATEINVENTORYIN";
        ...
        private bool mixedSourceLine()
        {
            for (int rowCounter = 1; rowCounter <= this.dtRecordDetailData.Rows.Count - 1; rowCounter++ )
            {
                if ((this.dtRecordDetailData.Rows[rowCounter]["C_INVOICELINE_ID"].ToString() == "" &&
                    this.dtRecordDetailData.Rows[0]["C_INVOICELINE_ID"].ToString() != "") ||
                    (this.dtRecordDetailData.Rows[rowCounter]["C_INVOICELINE_ID"].ToString() != "" &&
                    this.dtRecordDetailData.Rows[0]["C_INVOICELINE_ID"].ToString() == ""))
                {
                    return true;
        ...
        private bool checkExistanceOfAllRequiredInformation()
        {
            ...
            if (this.mixedSourceLine())
            {
                this.sbStatusLabel.Text = "Mixing Invoiced and non invoiced Recieved items is not allowed.";
                this.dtgMoveLine.BackgroundColor = Color.Yellow;
                missingFieldExist = true;
            }
            else
        ...
        private void changeRecordDetailTableStructure()
        {
                ...
                this.enmCurrentTask != taskType.Unkown)
            {
                ...
                this.dtRecordDetailData.Columns.Add("Invoice NO");
                this.dtRecordDetailData.Columns.Add("Invoiced");
                this.dtRecordDetailData.Columns.Add("Received");
                ...
                this.dtRecordDetailData.Columns["Invoice NO"].SetOrdinal(5);
                this.dtRecordDetailData.Columns["Invoiced"].SetOrdinal(6);
                this.dtRecordDetailData.Columns["Received"].SetOrdinal(7);
            }
        }
        ...
        private void fillDataToRecordDetailGidView()
        {
            if (this.enmCurrentRecordType != recordType.unkown)
            {
                ...
                this.dtgMoveLine.Columns["QTYPENDING"].Visible = false;
                ...
                this.dtgMoveLine.Columns["QTYENTERED"].DefaultCellStyle.Format = "N2";
                this.dtgMoveLine.Columns["Invoiced"].DefaultCellStyle.Format = "N2";
                this.dtgMoveLine.Columns["Received"].DefaultCellStyle.Format = "N2";
        ...
        private void loadSearchResultDataToExistingMainRecord()
        {
                ...
                (generalResultInformation.searchResult))
            {
                if (this.dtExistingRecordData.Columns.Count <= 0)
                {
                    ...
                    this.dtExistingRecordData.Columns.Add("VENDOR");
            ...
            this.dtExistingRecordData.Columns["VENDOR"].SetOrdinal(5);
            this.dtExistingRecordData.Columns["STORE FROM"].SetOrdinal(6);
        }
        ...
        private bool isCurrentIncomingExceedOrderedQty()
        {
            ...
            string invoicedQty =
                this.dtRecordDetailData.Rows[currentSelectedRowIndex]["Invoiced"].ToString();
            ...
            return decimal.Parse(this.ntbQuantity.Amount) >
                        decimal.Parse(invoicedQty) -
                         (
                            this.dtRecordDetailData.Rows[currentSelectedRowIndex]["Received"].ToString() != "" ?
                            decimal.Parse(this.dtRecordDetailData.Rows[currentSelectedRowIndex]["Received"].ToString()) :
                         0);
        }

        private bool isCurrentIncomingInvoiced()
        {
            if (this.dtgMoveLine.SelectedRows.Count < 1)
            {
                return false;
            ...
            return this.dtRecordDetailData.Rows[currentSelectedRowIndex]["C_INVOICELINE_ID"].ToString() != "";
        }
        ...
        private void addOrModifyRecordDetail(bool removeReocrd)
        {
            ...
            if (this.enmCurrentTask == taskType.In)
            {                
        ...
        private string createInvoiceList()
        {
                    ...
                    currentDetailRecord++)
            {
                if (this.dtRecordDetailData.Rows[currentDetailRecord]
                    ["C_INVOICELINE_ID"].ToString() != "")
                {
                    dtInvoiceInfo =
                        this.getDataFromDb.getINVOICEDETAILInfo(null, "", "", "", "",
                            this.dtRecordDetailData.Rows[currentDetailRecord]["C_INVOICELINE_ID"].ToString(),
                            "", "", false, false, "AND", "", "");
                    if (this.getDataFromDb.checkIfTableContainesData(dtInvoiceInfo))
                    {
                        invoiceList.Add(dtInvoiceInfo.Rows[0]["DOCUMENTNO"].ToString());
                    }
                }
            }

            if (invoiceList.Count > 0)
                return string.Join(", ", invoiceList.Distinct().ToArray());
            else
                return "";
        }

        private bool createInvoiceMatching() 
        {

            DataTable dtDetailInventoryIn = this.dtRecordDetailData.Copy();
            DataTable dtInvDetailInfo = new DataTable();

            DataTable dtNewMatchInvoice =
                    this.getDataFromDb.getM_MATCHINVInfo(null, "", "", "", "", "", false, true, "");

            for (int rowCounter = 0; rowCounter <= dtDetailInventoryIn.Rows.Count - 1; rowCounter++)
            {
                if (dtDetailInventoryIn.Rows[rowCounter]["C_INVOICELINE_ID"].ToString() == "")
                {
                    continue;
                }
                ...
                dtInvDetailInfo =
                    this.getDataFromDb.getINVOICEDETAILInfo(null, "", "", "", "",
                                dtDetailInventoryIn.Rows[rowCounter]["C_INVOICELINE_ID"].ToString(),
                                "", "", false, false, "AND", "", "");

                if (!this.getDataFromDb.checkIfTableContainesData(dtInvDetailInfo))
                {                    
                    continue;
                }
                ...
                string newMatchDate =
                    new DateTime(
                            Math.Max(
                                        this.dtpMoveDate.Value.Ticks,
                                        DateTime.Parse(dtInvDetailInfo.Rows[0]["DATEORDERED"].ToString()).Ticks
                                    )
                        ).ToString("yyyy-MM-dd HH:mm:ss");
                
                decimal matchedQty = 
                    Math.Min(
                        Decimal.Parse(dtDetailInventoryIn.Rows[rowCounter]["QTYENTERED"].ToString()),
                        Decimal.Parse(dtInvDetailInfo.Rows[0]["QTYENTERED"].ToString())
                    );
                ...
                dtNewMatchInvoice.Rows.Add(
                    ...
                    dtDetailInventoryIn.Rows[rowCounter]["AD_ORG_ID"].ToString(),
                    "Y",
                    DateTime.Now,
                    generalResultInformation.userId,
                    DateTime.Now,
                    generalResultInformation.userId,
                    dtDetailInventoryIn.Rows[rowCounter]["M_INOUTLINE_ID"].ToString(),
                    dtDetailInventoryIn.Rows[rowCounter]["C_INVOICELINE_ID"].ToString(),
                    dtDetailInventoryIn.Rows[rowCounter]["M_PRODUCT_ID"].ToString(),
                    newMatchDate,
                    matchedQty,
                    "N",
                    "Y",
            ...
            if (this.getDataFromDb.checkIfTableContainesData(dtNewMatchInvoice))
            {
                result =
        ...
        private void frmInventoryIn_Load(object sender, EventArgs e)
        {            
            ...
            this.userCanCreateInventoryIn =
                this.canUserCreateInventoryIncoming(false);
        ...
        {  
            ...
            if (this.userCanCreateInventoryIn)
            {
                this.prepareForNewTask(taskType.In);
            }
        }
        ...
        private void tscmdSave_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!this.canUserCreateInventoryIncoming(true))
                {
            ...
            newRecordDatarow["AD_USER_ID"] = this.stCurrentDocumentId;
            newRecordDatarow["SALESREP_ID"] = this.stCurrentDocumentId;
            newRecordDatarow["AD_USER_ID"] = this.stCurrentDocumentId;
            ...
            for (int rowCounter = this.dtRecordDetailData.Rows.Count - 1; rowCounter >= 0; rowCounter--)
            {
                                ...
                                ["C_INVOICELINE_ID"].ToString() != "")
                {
                    DataTable dtInvoiceInfo =
                        this.getDataFromDb.getINVOICEDETAILInfo(null, "", "", "", "",
                               this.dtRecordDetailData.Rows[rowCounter]
                                ["C_INVOICELINE_ID"].ToString(),
                                "", "", false, false, "AND", "", "");

                    newRecordDatarow["C_INVOICE_ID"] =
                        dtInvoiceInfo.Rows[0]["C_INVOICE_ID"].ToString();

                    if (this.dtRecordDetailData.Rows[this.dtRecordDetailData.Rows.Count - 1]
                            ["C_ORDERLINE_ID"].ToString() != "")
                    {
                        DataTable dtOrderInfo =
                            this.getDataFromDb.getINVOICEDETAILInfo(null, "", "", "", "",
                                    "", "",
                                    this.dtRecordDetailData.Rows[this.dtRecordDetailData.Rows.Count - 1]
                                        ["C_ORDERLINE_ID"].ToString(),
                                        "", "", false, false, "AND", "", "");

                        newRecordDatarow["C_ORDER_ID"] =
                            dtOrderInfo.Rows[0]["C_ORDER_ID"].ToString();

                        newRecordDatarow["DATEORDERED"] =
                            dtOrderInfo.Rows[0]["DATEORDERED"].ToString();
            ...
            this.dtRecordDetailData.Columns.RemoveAt
                (this.dtRecordDetailData.Columns.IndexOf("Invoice NO"));
            this.dtRecordDetailData.Columns.RemoveAt
                (this.dtRecordDetailData.Columns.IndexOf("Invoiced"));
            this.dtRecordDetailData.Columns.RemoveAt
                (this.dtRecordDetailData.Columns.IndexOf("Received"));
        ...
        private void tscmdConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (!this.createInvoiceMatching())
            {
                MessageBox.Show("Unable to create Matching.\n Please Contcat you Administrator", "Inventory In", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }

            DataTable dtDetailInventoryIn = this.dtRecordDetailData.Copy();
            
            for (int columnCounter = dtDetailInventoryIn.Columns.Count - 1; columnCounter >= 0; columnCounter--)
            {
                if (dtDetailInventoryIn.Columns[columnCounter].ColumnName != "C_INVOICELINE_ID" &&
                    dtDetailInventoryIn.Columns[columnCounter].ColumnName != "QTYENTERED")
                {
                    dtDetailInventoryIn.Columns.RemoveAt(columnCounter);
                }
            }

            DataTable dtInvDetailInfo;

            for (int rowCounter = dtDetailInventoryIn.Rows.Count - 1; rowCounter >= 0; rowCounter--)
            {
                if (dtDetailInventoryIn.Rows[rowCounter]["C_INVOICELINE_ID"].ToString() == "")
                {
                    dtDetailInventoryIn.Rows.RemoveAt(rowCounter);
                    continue;
                }
                ...
                dtDetailInventoryIn.Rows[rowCounter]["QTYENTERED"] =
                   decimal.Parse(dtInvDetailInfo.Rows[0]["QTYRECEIVED"].ToString()) +
                   decimal.Parse(dtDetailInventoryIn.Rows[rowCounter]["QTYENTERED"].ToString());
            }

            if (this.getDataFromDb.checkIfTableContainesData(dtDetailInventoryIn))
            {
                dtDetailInventoryIn.Columns["QTYENTERED"].ColumnName = "QTYRECEIVED";
                this.getDataFromDb.changeDataBaseTableData(dtDetailInventoryIn, "INVOICEDETAIL", "UPDATE");
            }
        ...
        private void tscmdSearch_Click(object sender, EventArgs e)
        {
            ...
            newSearch.enmTaskType = taskType.In;
        ...
        private void tscmdShowPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (!System.IO.File.Exists("crptInventoryIn.rpt"))
            {
                this.documentPreviewHidden = true;
            ...
            dtMovementDetailInfo.Columns["Invoiced"].ColumnName = "PendingQty";
                ...
                rowCounter <= dtMovementDetailInfo.Rows.Count - 1; rowCounter++)
            {
                ...
                drMovementDetailInfoForReporting["PendingQty"] =
                   dtMovementDetailInfo.Rows[rowIndexToInsert]["PendingQty"];
            ...
            this.crptMaterialMovement.FileName = "crptInventoryIn.rpt";
        ...
        private void cmdAddOrModifyRecordDetail_Click(object sender, EventArgs e)
        {
            ...
            if (!this.isCurrentIncomingInvoiced())
            {
            ...
            } else if (this.isCurrentIncomingExceedOrderedQty())
            {
                DialogResult dglRslt =
            ...
            if (errorOnItemsToAdd)
            {
                ...
                generalResultInformation.codeR = codeRequested.None;
        ...
        private void ddgProduct_SelectedItemClicked(object sender, EventArgs e)
        {
            DataTable productInformation = 
                getDataAccordingToRule.getProducts(true, true,triStateBool.ignor, triStateBool.yes, 
        ...
        {            
                ...
                this.dtActiveOrganisationsAccessableToUser.Rows.Count - 1)
            {
                ...
                this.dtWareHousesAccessableToUser =
                    getDataAccordingToRule.getUserAccessableLocators("", triStateBool.No, taskType.In);
        ...
        private bool userCanPrintCurrentRecord()
        {
            ...
            if (dtcurrentUserCurrentRecordProcessAcess.Rows[0]["CreateInventoryIn"].ToString() == "Y")
            {
                return true;
            }
            else
        ...
        private void frmInventoryIn_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void cmdCreateLinesFrom_Click(object sender, EventArgs e)
        {
            ...
            frmInventoryInSourceInvoice frmNewSource = new frmInventoryInSourceInvoice();
            ...
            frmNewSource.dtExistingInvoiceItemList =
                this.dtRecordDetailData.Copy();
            ...
            for (int rowCounter = 0; rowCounter <= generalResultInformation.incomingInventorySourceInvoice.Rows.Count - 1; rowCounter++)
            {
                ...
                drNewDetailRecordRow["M_PRODUCT_ID"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["M_PRODUCT_ID"];                
                drNewDetailRecordRow["PRODUCT"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["PRODUCT"];
                drNewDetailRecordRow["QTYENTERED"] =
                    decimal.Parse(generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["QTYENTERED"].ToString()) -
                    decimal.Parse(generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["QTYRECEIVED"].ToString());
                drNewDetailRecordRow["MOVEMENTQTY"] = 
                    drNewDetailRecordRow["QTYENTERED"];
                drNewDetailRecordRow["C_UOM_ID"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["C_UOM_ID"];
                drNewDetailRecordRow["UNIT"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["UNIT"];

               
                drNewDetailRecordRow["C_ORDERLINE_ID"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["C_ORDERLINE_ID"];
                drNewDetailRecordRow["C_INVOICELINE_ID"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["C_INVOICELINE_ID"];
                

                drNewDetailRecordRow["Invoice NO"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["DOCUMENTNO"];
                drNewDetailRecordRow["Invoiced"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["QTYENTERED"];
                drNewDetailRecordRow["Received"] =
                    generalResultInformation.incomingInventorySourceInvoice.Rows[rowCounter]["QTYRECEIVED"];
