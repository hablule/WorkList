...
namespace EasyMove
{
    public partial class frmSearchInventoryMake : Form
    {
        public frmSearchInventoryMake()
        {
            InitializeComponent();
        }
        ...
        private void establishSearchCriterion()
        {
            ...
            {
                this.addMoreCriteria("PRODUCTIONL_LOCATORID", this.cmbMoveFromLogic.SelectedItem.ToString(),
            ...
            {
                this.addMoreCriteria("PRODUCTIONP_PRODUCTID", this.cmbProductLogic.SelectedItem.ToString(),
                    this.ddgProduct.SelectedRowKey.ToString(), "");
            }

            if (this.cmbComponentLogic.SelectedItem.ToString() != "IGNOR" &&
                this.ddgComponent.SelectedRowKey != null)
            {
                this.addMoreCriteria("PRODUCTIONL_PRODUCTID", this.cmbComponentLogic.SelectedItem.ToString(),
                    this.ddgComponent.SelectedRowKey.ToString(), "");
            }

            if (this.cmbMoveQuantityLogic.SelectedItem.ToString() != "IGNOR")
            {
                this.addMoreCriteria("MOVEMENTQTY", this.cmbMoveQuantityLogic.SelectedItem.ToString(),
        ...
        private void frmSearchInventoryMake_Load(object sender, EventArgs e)
        {
            ...
            this.cmbComponentLogic.SelectedItem = "IGNOR";
            ...
            this.accessableLocators = this.getData.getUserAccessableLocators("", triStateBool.No, taskType.Make);
            ...
            this.accessableDocuments =
                getData.getDocuments(true, false, "", true, taskType.Make);
        ...
        private void cmbComponentLogic_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.enableDisableValueInsertionBox(this.cmbComponentLogic.SelectedItem.ToString(),
                this.ddgComponent);
        }
        ...
        private void ddgProduct_SelectedItemClicked(object sender, EventArgs e)
        {
            ...
            this.ddgProduct.DataSource = productInformation;
            this.ddgProduct.DataTablePrimaryKey = Convert.ToUInt16(productInformation.Columns.IndexOf("M_PRODUCT_ID"));
            this.ddgProduct.SelectedColomnIdex = productInformation.Columns.IndexOf("NAME");
            ...
            this.ddgProduct.HiddenColoumns = hiddenProductColumns;
        }

        private void ddgComponent_SelectedItemClicked(object sender, EventArgs e)
        {

            DataTable componentInformation =
                getData.getProducts(true, false, triStateBool.ignor, triStateBool.ignor,
                                    triStateBool.ignor, triStateBool.No, triStateBool.ignor,
                                    true, this.ddgComponent.SelectedItem, "", true);
            this.ddgComponent.DataSource = componentInformation;
            this.ddgComponent.DataTablePrimaryKey = Convert.ToUInt16(componentInformation.Columns.IndexOf("M_PRODUCT_ID"));
            this.ddgComponent.SelectedColomnIdex = componentInformation.Columns.IndexOf("NAME");
            int[] hiddenProductColumns = { componentInformation.Columns.IndexOf("C_UOM_ID"), 
                                             componentInformation.Columns.IndexOf("M_PRODUCT_CATEGORY_ID") };
            this.ddgComponent.HiddenColoumns = hiddenProductColumns;
        }
        ...
        private void cmdSearch_Click(object sender, EventArgs e)
        {
            ...
            generalResultInformation.searchResult =
                this.getDataFromDb.clearRedundantRow(generalResultInformation.searchResult, "M_PRODUCTION_ID");
            ...
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("ISCREATED"));
            ...
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("AD_ORGTRX_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("C_PROJECT_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("C_CAMPAIGN_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("C_ACTIVITY_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("USER1_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("USER2_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("M_PRODUCTIONPLAN_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_LINE"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_PRODUCTID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_PRODUCT"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONQTY"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_LOCATORID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_STR"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_DESC"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_UOMID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONP_Unit"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("M_PRODUCTIONLINE_ID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_LINE"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_PRODUCTID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_PRODUCT"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("MOVEMENTQTY"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_LOCATORID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_STR"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_DESC"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_UOMID"));
            generalResultInformation.searchResult.Columns.RemoveAt(generalResultInformation.searchResult.Columns.IndexOf("PRODUCTIONL_Unit"));
            ...
            generalResultInformation.searchResult.Columns.Add("STORE");
            ...
            for (int rowCounter = 0; rowCounter <= generalResultInformation.searchResult.Rows.Count - 1; rowCounter++)
            {
                if (generalResultInformation.searchResult.Rows[rowCounter]["DOCUMENT"].ToString() != "" &&
                    ...
                    generalResultInformation.searchResult.Rows[rowCounter]["STORE"].ToString() != "")
                {
                    continue;
                }
                ...
                if (generalResultInformation.searchResult.Rows[rowCounter]["STORE"].ToString() == "")
                {
                    inventoryInInfo =
                    ...
                    if (this.getDataFromDb.checkIfTableContainesData(inventoryInInfo))
                    {
                        generalResultInformation.searchResult.Rows[rowCounter]["STORE"] =
                            inventoryInInfo.Rows[0]["NAME"].ToString();
                ...
                for (int rowCounter2 = rowCounter + 1; rowCounter2 <= generalResultInformation.searchResult.Rows.Count - 1; rowCounter2++)
                {
                    if (generalResultInformation.searchResult.Rows[rowCounter2]["DOCUMENT"].ToString() != "" &&
                        ...
                        generalResultInformation.searchResult.Rows[rowCounter2]["STORE"].ToString() != "")
                    {
                        continue;
                    }
                    ...
                    if (generalResultInformation.searchResult.Rows[rowCounter2]["STORE"].ToString() == "" &&
                        (generalResultInformation.searchResult.Rows[rowCounter]["M_WAREHOUSE_ID"].ToString() ==
                        generalResultInformation.searchResult.Rows[rowCounter2]["M_WAREHOUSE_ID"].ToString()))
                    {
                        generalResultInformation.searchResult.Rows[rowCounter2]["STORE"] =
                            generalResultInformation.searchResult.Rows[rowCounter]["STORE"];
                    }
                }
            ...
            generalResultInformation.searchResult.Columns["NAME"].ColumnName = "DOCUMENTNO";
        ...
        private void cmbSearchAndIncludeToPreviousResult_Click(object sender, EventArgs e)
        {
            ...
            string columnNameToCompareWith = "M_PRODUCTION_ID";

            this.establishSearchCriterion();

            currentSearchCriteriaResult =
                this.getDataFromDb.getV_PRODUCTIONDETAILInfo(this.searchQuery, this.logicalConnector, "",
                        "", "", "", "", false, false, "AND", "", "");
