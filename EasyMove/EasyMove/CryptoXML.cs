...
namespace EasyMove
{
	...
	public class XMLEncryptor
	{
        ...
        public DataTable ReadEncryptedXML(string fileName)
		{
        ...
        public void WriteEncryptedXML(DataTable aDataTable, string encFileName)
		{
			FileStream fOut;
            ...
            {
                Trace.WriteLine(exc.Message + "Cannot perform encryption");
                return;
            }
